package com.wandrip.imageslider.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.wandrip.imageslider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.wandrip.imageslider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.wandrip.imageslider.Animations.BaseAnimationInterface}
 * work.
 *
