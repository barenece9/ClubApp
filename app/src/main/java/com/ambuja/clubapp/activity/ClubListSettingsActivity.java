...
public class ClubListSettingsActivity extends BaseActivity {
      ...
      /*  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        mClubList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Constants.clubId = Constants.clubList.get(position).id;

                store.setString("clubId", Constants.clubId);

                Intent intent = new Intent(ClubListSettingsActivity.this, HomeActivity.class);
